...
# Generated by qmake (2.01a) (Qt 4.8.1) on: Wed Jul 3 00:45:01 2013
# Project:  launcher.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile launcher.pro
#############################################################################
...
LINK          = g++
LFLAGS        = -Wl,-O1
LIBS          = $(SUBLIBS)  -L/usr/lib/i386-linux-gnu -lQtDeclarative -lQtGui -lQtCore -lpthread 
AR            = ar cqs
RANLIB        = 
QMAKE         = /usr/bin/qmake
TAR           = tar -cf
...
Makefile: launcher.pro  /usr/share/qt4/mkspecs/linux-g++/qmake.conf /usr/share/qt4/mkspecs/common/unix.conf \
		/usr/share/qt4/mkspecs/common/linux.conf \
		/usr/share/qt4/mkspecs/common/gcc-base.conf \
		/usr/share/qt4/mkspecs/common/gcc-base-unix.conf \
		/usr/share/qt4/mkspecs/common/g++-base.conf \
...
dist: 
	@$(CHK_DIR_EXISTS) .tmp/launcher1.0.0 || $(MKDIR) .tmp/launcher1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) .tmp/launcher1.0.0/ && $(COPY_FILE) --parents qmlapplicationviewer/qmlapplicationviewer.h procExec.h .tmp/launcher1.0.0/ && $(COPY_FILE) --parents main.cpp qmlapplicationviewer/qmlapplicationviewer.cpp .tmp/launcher1.0.0/ && (cd `dirname .tmp/launcher1.0.0` && $(TAR) launcher1.0.0.tar launcher1.0.0 && $(COMPRESS) launcher1.0.0.tar) && $(MOVE) `dirname .tmp/launcher1.0.0`/launcher1.0.0.tar.gz . && $(DEL_FILE) -r .tmp/launcher1.0.0
...
compiler_moc_header_make_all: moc_qmlapplicationviewer.cpp moc_procExec.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_qmlapplicationviewer.cpp moc_procExec.cpp
...
moc_procExec.cpp: procExec.h
	/usr/bin/moc-qt4 $(DEFINES) $(INCPATH) procExec.h -o moc_procExec.cpp
...
moc_procExec.o: moc_procExec.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_procExec.o moc_procExec.cpp
